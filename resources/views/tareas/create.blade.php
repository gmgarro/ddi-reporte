...
<div class="form-container">
    ...
    <form method="POST" action="{{ route('tareas.store') }}" id="tareaForm">
        @csrf
        ...
        <div class="form-group">
            ...
            <div class="input-wrapper">
                ...
                <select name="frecuencia" id="frecuencia" class="form-control" required>
                    <option value="unica" {{ old('frecuencia', 'unica') === 'unica' ? 'selected' : '' }}>Única vez</option>
                ...
                @foreach([
                    ...
                    <div class="dia-option">
                        <input type="checkbox" name="dias_semana[]" value="{{ $dia['value'] }}" 
                               id="dia-{{ $dia['value'] }}"
                               {{ is_array(old('dias_semana')) && in_array($dia['value'], old('dias_semana')) ? 'checked' : '' }}>
