...
<div class="form-container">
    ...
    <form method="POST" action="{{ route('clientes.puntos-venta.update', [$cliente, $puntoVenta]) }}">
        @csrf
        @method('PUT')
            ...
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    ...
                    <input 
                        ...
                        name="nombre" 
                        class="form-control"
                        value="{{ old('nombre', $puntoVenta->nombre) }}"
                    ...
                    <select name="provinciaId" class="form-control" required>
                        ...
                        @foreach($provincias as $prov)
                            <option value="{{ $prov->id }}"
                                {{ old('provinciaId', $puntoVenta->provinciaId) == $prov->id ? 'selected' : '' }}>
                                {{ $prov->nombre }}
                            </option>
                        @endforeach
                    </select>
            ...
            <div class="coordinates-grid">
                <div class="form-group">
                    ...
                    <input 
                        ...
                        value="{{ old('latitud', $puntoVenta->latitud) }}"
                ...
                <div class="form-group">
                    ...
                    <input 
                        ...
                        id="longitud" 
                        class="form-control coordinate-input"
                        value="{{ old('longitud', $puntoVenta->longitud) }}"
...
<script>
    ...
    let lat = {{ old('latitud', $puntoVenta->latitud) }};
    let lng = {{ old('longitud', $puntoVenta->longitud) }};
